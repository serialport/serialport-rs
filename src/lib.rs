...
/// convenience type for Port
pub type NativePort = unimplemented!();
...
impl SerialPortBuilder {
    ...
    /// Open a native port with the specified settings
    pub fn open(self) -> Result<NativePort> {
        NativePort::open(&self)
    }
}
