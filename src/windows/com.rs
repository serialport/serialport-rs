...
use {
    BaudRate, DataBits, FlowControl, Parity, SerialPort, SerialPortInfo, SerialPortSettings,
    StopBits,
};
use {Error, ErrorKind};
...
pub fn available_baud_rates() -> Vec<u32> {
    vec![
        110, 300, 600, 1200, 2400, 4800, 9600, 14_400, 19_200, 38_400, 57_600, 115_200, 128_000,
        256_000,
    ]
}
